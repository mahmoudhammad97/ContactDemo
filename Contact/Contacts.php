...
<!----------------------Contacts---------------------->
	<nav class="navbar navbar-light bg-light">
	  <div class="container-fluid d-flex justify-content-center">
		  <img src="Google_Contacts_logo.PNG" alt="google_logo" width="50" height="50" class="d-inline-block align-text-top">
	...
	<div style="padding: 10px;background: #fff;">	
		<form class="d-flex">
			...
			<img src="icons8-plus.png" onclick="new_contact()" class="material-symbols-outlined" style="cursor:pointer">
		</form>
	</div>
<!----------------------table---------------------->
